...
/**
 * Handles the press/media coverage page.
 */
final class PressController extends AbstractController
{
    /**
     * Displays the press coverage page with categorized media items.
     *
     * @param TranslatorInterface $translator The translator service
     * @return Response The press page response
     */
    ...
    public function index(TranslatorInterface $translator): Response
    {
        $pressItems = [
            ...
            [
                'category' => 'written',
                'source' => 'Instagram (destandaard)',
                'title' => 'Drie jaar geleden kreeg Adem Schol (10) uit Ukkel genoeg van de druggebruikers en dealers in zijn straat. Hij joeg ze weg door het steegje vol te zetten met vogelhuisjes',
                'url' => 'https://www.instagram.com/destandaard',
                'type' => 'article',
                'image' => null,
            ],
            [
                'category' => 'written',
                'source' => 'HLN',
                'title' => 'Dilbeek zet meertaligheid in de kijker met pancarte… Adem Schol en Johan Verminnen geëerd als \'Brusseleir Van \'t Joêr\'',
            ...
            [
                'category' => 'written',
                'source' => 'Nieuwsblad',
                'title' => 'Johan Verminnen en 10-jarige ket verkozen tot Brusseleir van\'t Joêr. Adem Schol (10) uit Ukkel vormde dit jaar een steegje om die een verzamelplaats voor crackrokers geworden in een plek waar families samenkomen',
            ...
            [
                'category' => 'written',
                'source' => 'Persinfo',
                'title' => 'Verkiezing Brusseleir Van\'t Joêr 2025 & Brusseleir Vè et Leive. Adem Schol is een 10-jarig Brussels ketsje en woont in een steegje… Adem Schol tot Brusseleir van\'t joêr',
                'url' => 'https://www.persinfo.org',
                'type' => 'article',
                'image' => null,
            ],
            [
